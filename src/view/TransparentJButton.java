...
public class TransparentJButton extends JButton {
    ...
    public TransparentJButton(String text) {
        super(text);
        setOpaque(false); //  le bouton n'est pas opaque
        setContentAreaFilled(false); //  la zone de contenu n'est pas remplie
        setBorderPainted(false); // la bordure n'est pas peinte
        setFocusPainted(false); // le focus n'est pas peint
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.7f)); // 0.7f pour 70% d'opacité
